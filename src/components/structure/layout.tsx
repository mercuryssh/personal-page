...
const github=(
  <div>
    <svg className={'icons'} xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" fill={'black'}
         viewBox="0 0 24 24">
      <path
      ...
      <Fragment>
        ...
        <div id={'layout'}>
          <AsideContainer side={'left'}>
            <Hamburger active={this.state.menuVisible} toggleActive={this.toggleMenu}/>
            {github}
          </AsideContainer>
